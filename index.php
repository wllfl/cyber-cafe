            ...
            <div class="col-md-3 box-servico">
                <div class="ca-hover">
                    ...
                    <div class="carousel-content">
                        <h3>JOGOS ONLINE</h3>
                        <p>Venha conhecer nossa sala de jogos com os consoles mais modernos do mercado, trabalhamos com 360, PS3 e PS4 e possuímos mais de 200 títulos de jogos ...</p>
                        <a href="jogos-online" class='link-home'>Veja +</a>
                    </div>
                </div>
            </div>
            <!-- FIM SERVIÇO 1 -->
