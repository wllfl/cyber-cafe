          ...
          <section id="img-servico">
            ...
            <div class="container">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li class="filter" data-filter="ps4">
                        <a href="#noAction">PS4</a>
                    </li>
...
<!--                     <div id="slidingDiv16" class="toggleDiv row-fluid single-project">
                    ...
                    <ul id="portfolio-grid" class="thumbnails row">
                        ...
                        <li class="span4 mix ps4">
                            <div class="thumbnail">
                                <img src="img/thumbs-games/batlefield-hardline.jpg" alt="Batlefild Hardline">
                                <a href="#single-project" class="show_hide more" rel="#slidingDiv2">
                                    <i class="icon-plus"></i>
                                </a>
                                <h3>BATLEFIELD HARDLINE</h3>
                                <p>Polícia X Ladrão</p>
                                <div class="mask"></div>
                            </div>
                        </li>
                        <li class="span4 mix ps4">
