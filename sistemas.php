...
<head>
	<meta charset="UTF-8">
	<title>Desenvolvimento de Sistemas - Cyber Café</title>
  ...
  <meta name="description" content="Desenvolvimentos de Sistemas, Desenvolvimento de Sites, Consultoria em Banco de Dados, Programação, Sites, Sistemas">
        ...
        <div>
            ...
            <div class='row-fluid'>
                <div class="col-sm-7 box-titulo">
                   <h1 class='title-pagina'><i class='fa fa-desktop fa-2x'></i> Sistemas e Sites</h1>        
                </div>      
            </div>
            ...
            <div class="container">
                <ul class="nav nav-pills">
                    ...
                    <li class="filter" data-filter="photo">
                        <a href="#noAction">Softwares</a>
                    </li>
                    <li class="filter" data-filter="identity">
                        <a href="#noAction">Consultorias</a>
                    </li>
                </ul>
                    ...
                    <ul id="portfolio-grid" class="thumbnails row">
                        ...
                        <li class="span4 mix identity">
                            <div class="thumbnail">
                                ...
                                <p>Otimização e Tunning de Banco de Dados</p>
                                <div class="mask"></div>
                            </div>
                        </li>
                        <li class="span4 mix web">
                            <div class="thumbnail">
                                ...
                                <h3>Sites Dinâmicos</h3>
                                <p>Desenvolvimento de Sites com CMS</p>
                                <div class="mask"></div>
                            </div>
                        </li>
                        <li class="span4 mix photo">
                            <div class="thumbnail">
                                ...
                                <p>Sistema para controle Financeiro</p>
                                <div class="mask"></div>
                            </div>
                        </li>
                        <li class="span4 mix identity">
                            <div class="thumbnail">
                                ...
                                <h3>Integrações Online</h3>
                                <p>Integrações com WebServices e APIs</p>
                                <div class="mask"></div>
                            </div>
                        </li>
                        <li class="span4 mix web">
                            <div class="thumbnail">
                                ...
                                <h3>Aplicações WEB</h3>
                                <p>Aplicações financeiras via WEB</p>
                                <div class="mask"></div>
                            </div>
                        </li>
                        <li class="span4 mix photo">
                        ...
                        <li class="span4 mix identity">
                            <div class="thumbnail">
                                ...
                                <p>HTML, CSS, JavaScript, PHP, Delphi e etc.</p>
                                <div class="mask"></div>
                            </div>
                        </li>
                    </ul>
